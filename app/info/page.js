  ...
  return (
    <>
      ...
      <div className="w-1/2 mx-auto mt-24 text-center">
        <p>
          Tato webová platforma vznikla v rámci projektu ESF „Sociální dialog pro sociální smír a hospodářský růst“, č.
          projektu: CZ.03.01.03/
          <wbr />
          00/
          <wbr />
          22_001/
      ...
      <div className="w-1/2 mx-auto mt-12 text-center">
        Projekt je financován z Evropského sociálního fondu prostřednictvím Operačního programu Zaměstnanost plus a
        státního rozpočtu České republiky.
      </div>
      <div className="w-1/2 mx-auto mt-12 text-center">
        Podrobnější informace a další výstupy najdete{" "}
        <Link
          href="https://www.cmkos.cz/projekty/evropske-projekty/socialni-dialog-pro-socialni-smir-a-hospodarsky-rust/"
          target="_blank"
        >
