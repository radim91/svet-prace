  ...
  return (
    <div className="items-center">
      <div className="headings">
        <h1 className="hidden md:block text-center fellix-bold text-7xl lg:text-9xl">Svět práce</h1>
      ...
      {windowSize.isMobile === true && (
        <>
          <Image src="/images/krumpac.svg" alt="Krumpáč" fill={true} id="mobile-pike" className="-ms-8 mt-16" />
          <Image src="/images/packy.svg" alt="Packy" fill={true} id="mobile-paws" className="-ms-[1000px] mt-16" />
          <Image
            src="/images/klavesnice.svg"
            alt="Klávesnice"
            fill={true}
      ...
      <div className="absolute inset-y-1/2 -mt-8 w-full z-100 flex justify-center">
        <div className="flex-row justify-center items-center">
          <div className="flex justify-center">
            <button className="intro-btn" onClick={sendToIntro}>
              Začít objevovat
            </button>
          </div>
          <div className="flex justify-center mt-4">
            <button className="materials-btn" onClick={sendToMaterials}>
              Materiály k výuce
            </button>
          </div>
        </div>
